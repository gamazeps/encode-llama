...
data class ExperimentFile(
        ...
        @Json(name = "genome_annotation") val genomeAnnotation: String?,
 ...
 */
fun EncodeExperiment.tissue() = if (biosampleOntology.organSlims.isEmpty()) "NA" else biosampleOntology.organSlims.joinToString(",")
...
fun ExperimentFile.latestHumanGenomeAnnotation() = genomeAnnotation == "V29"
fun ExperimentFile.latestMouseGenomeAnnotation() = genomeAnnotation == "M21"
