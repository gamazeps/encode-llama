...
class PsychEncodeAvgExpByScHttpSource(private val psychencodeUrl: String, private val dataset: String) : PsychEncodeAvgExpByScSource {
    override fun import(sink: PsychEncodeAvgExpByScSink) {
        log.info { "Beginning Psych Encode dataset avg exp by sc data Import" }
        ...
        log.info { "Psych Encode dataset avg exp by sc data complete" }
    }
}

private fun importData(dataset: String, sink: PsychEncodeAvgExpByScSink, inputStream: InputStream) {
