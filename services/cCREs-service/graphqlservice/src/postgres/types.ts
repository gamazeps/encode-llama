export type SCREENSearchParameters = {
    accessions?: string[];
    assembly: string;
    cellType?: string;
    coord_chrom: string;
    ...
    coord_start: number;
    element_type?: string;
    gene_all_start?: number;
    gene_all_end?: number;
    gene_pc_start?: number;
    gene_pc_end?: number;
    rank_ctcf_end: number;
    rank_ctcf_start: number;
    rank_dnase_end: number;
    rank_dnase_start: number;
    rank_enhancer_end: number;
    rank_enhancer_start: number;
    rank_promoter_end: number;
    rank_promoter_start: number;
    uuid: string;
};
